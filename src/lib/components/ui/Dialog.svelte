...
<button
	use:melt={$trigger}
	class="inline-flex items-center justify-center rounded-t-xl bg-white px-4 py-3
...
{#if $open}
	<div class="" use:melt={$portalled}>
		...
		/>
		<div
			class="fixed left-1/2 bottom-0 z-50 max-h-[85vh] w-[100vw]
            max-w-[450px] -translate-x-1/2 rounded-t-xl bg-white
            p-6 shadow-lg"
			transition:fly={{
				duration: 500,
				y: 100
